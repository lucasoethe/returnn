...
def test_Data_copy_compatible_to_add_feature_dim():
  common_data = Data(name='energy', shape=(None, 3), batch_dim_axis=None)  # [T,F]
  d1 = Data(name='mask', shape=(None,), batch_dim_axis=None, time_dim_axis=0, feature_dim_axis=None)  # [T]
  d2 = d1.copy_compatible_to(common_data)
  assert d2.batch_dim_axis is None and d2.time_dim_axis is not None and d2.batch_shape == (None, 1, 1)
...
def test_Data_copy_compatible_to_add_batch_feature_dim():
  ...
  d1 = Data(name='mask', shape=(None,), batch_dim_axis=None, time_dim_axis=0, feature_dim_axis=None)  # [T]
  d2 = d1.copy_compatible_to(common_data)
  assert d2.batch_dim_axis is not None and d2.time_dim_axis is not None and d2.batch_shape == (None, 1, 1)
